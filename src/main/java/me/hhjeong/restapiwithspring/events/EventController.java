...
public class EventController {
	...
	public ResponseEntity createEvent(@RequestBody @Valid EventDto eventDto, Errors errors) {
		...
		//entityModel.add(linkTo(EventController.class).slash(event.getId()).withSelfRel()); //self
		entityModel.add(selfLinkBuilder.withSelfRel()); //self
		entityModel.add(linkTo(EventController.class).withRel("query-events"));
		entityModel.add(linkTo(EventController.class).withRel("update-events"));
